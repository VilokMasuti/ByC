...
export default function ChatbotIntegration({ onPrev }: { onPrev: () => void }) {
  ...
  return (
    <motion.div
      ...
      className="space-y-6"
    >
      <h2 className="text-3xl font-bold text-center bg-gradient-to-r from-white to-zinc-500 bg-clip-text text-transparent">
      ...
      <AnimatePresence mode="wait">
        ...
        {step === 'integrate' && (
          ...
          >
              ...
              <CardContent className="space-y-4 p-6">
                <div className="space-y-2">
                  <Label className="text-base text-zinc-400">
                    Copy-paste this code in your website&apos;s {'<head>'} tag:
                  </Label>
                  <pre className="bg-zinc-800 p-4 rounded-md text-sm overflow-x-auto text-zinc-300">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="text-base py-6 bg-zinc-800 border-zinc-700 text-white placeholder:text-zinc-500"
                  />
                  <Button
                    className="w-full text-base py-6 bg-zinc-700 hover:bg-zinc-600 text-white"
            ...
            <Button
              variant="outline"
              className="w-full text-base py-6 text-zinc-400 border-zinc-700 hover:bg-zinc-800"
      ...
      <Dialog open={showFeedbackDialog} onOpenChange={setShowFeedbackDialog}>
        <DialogContent className="sm:max-w-[425px] bg-zinc-900 border-zinc-800">
          ...
          <div className="space-y-4 py-4">
            <Label htmlFor="feedback" className="text-base text-zinc-400">
              Your Feedback
            </Label>
            <Textarea
              id="feedback"
              ...
              className="h-32 text-base bg-zinc-800 border-zinc-700 text-white placeholder:text-zinc-500"
            />
          </div>
          <DialogFooter>
            <Button
